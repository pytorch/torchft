...
ProcessGroupNCCL::ProcessGroupNCCL(
  ...
  dumpOnTimeoutOrEx_ = false;
  propagatePgError_ = false;
  ...
  heartbeat_ = 1ULL;
  monitorThreadEnabled_.store(false);
...
bool ProcessGroupNCCL::dumpDebuggingInfo(bool includeStackTrace) {
  return true;
}
